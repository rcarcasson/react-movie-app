...
export default function StackNavigation(props) {
    ...
    return (
        <Stack.Navigator>
            ...
            <Stack.Screen name='movie' component={Movie} options={{headerTransparent:true, title: '', headerLeft: () => buttonLeft('movie'), headerRight: () => buttonRight()}}></Stack.Screen>
            ...
            <Stack.Screen name='search' component={Search} options={{title: '', headerTransparent:true, headerLeft: () => buttonLeft('search')}}></Stack.Screen>
        </Stack.Navigator>
    );
}